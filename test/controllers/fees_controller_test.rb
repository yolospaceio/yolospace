...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { fee_type: @fee.fee_type, name: @fee.name, percentage: @fee.percentage, price: @fee.price } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { fee_type: @fee.fee_type, name: @fee.name, percentage: @fee.percentage, price: @fee.price } }
